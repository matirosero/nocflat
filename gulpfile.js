...
gulp.task('serve', ['svg-sprite', 'optimize-images', 'styles', 'js', 'browser-sync', 'watch']); //'foundation-js', was here after browser-sync and before watch
